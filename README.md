...
Deployed on cloud for global access
...
Emotion is mapped to music category
Suitable music is recommended instantly

☁️ Deployment
The application is deployed on Render, providing a stable and scalable environment.
Users can access the project directly from their browser without installing any dependencies.

🧪 Installation & Setup
git clone https://github.com/your-username/your-repo-name.git
cd AI_Powered_Music_Generator
